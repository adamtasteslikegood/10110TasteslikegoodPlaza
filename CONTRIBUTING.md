...
Thanks for working on **10110 TastesLikegood Plaza**. This file is the day-to-day reference for contributors (human or agent). For the formal policy — protected branches, required status checks, CODEOWNERS gating — see [`specs/branching-strategy.md`](specs/branching-strategy.md).

## Before you start

1. **Clone with submodules.** The 137+ agent definitions live in a submodule. Fresh checkouts won't have them.
   ```bash
...
4. Wait for CI (`Lint Python Bridge` + the Godot export stub) and any reviewer feedback.
...
- [`docs/agent-directory.md`](docs/agent-directory.md) — taxonomy of the 137+ roles.
