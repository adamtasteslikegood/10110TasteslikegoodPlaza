...
### Scene 3 — Keys in hand (preview pan)
...
### Scene 5 — Meet the Systems Architect
- **Type:** Dialogue
...
### Scene 6 — Security Auditor at the door
- **Type:** Dialogue
...
### Scene 7 — Your office (setup prompt)
- **Type:** Player choice
...
### Scene 8 — Engineering floor opens
- **Type:** Event
...
### Scene 9 — Product Manager drops by
- **Type:** Dialogue
...
### Scene 10 — Design lead hallway run-in
...
### Scene 11 — End of day assistant debrief
- **Type:** Tutorial
...
### Scene 12 — Morning standup (war room)
...
### Scene 13 — Coding lesson (language lab)
- **Type:** Tutorial
...
### Unlock: AI/Automation floor (the engine room)
...
### Scene — End of Week 1 founder check-in
- **Type:** Cutscene
